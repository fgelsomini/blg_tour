...
function DisplayTemplate_16fe896fe68c4ee78da7535ff7577ab2(ctx) {
  var ms_outHtml=[];
  var cachePreviousTemplateData = ctx['DisplayTemplateData'];
  ctx['DisplayTemplateData'] = new Object();
  DisplayTemplate_16fe896fe68c4ee78da7535ff7577ab2.DisplayTemplateData = ctx['DisplayTemplateData'];

  ctx['DisplayTemplateData']['TemplateUrl']='~sitecollection\u002f_catalogs\u002fmasterpage\u002fBLGPublishing\u002fDisplay Templates\u002fSearch\u002fFilter_BLGDefault.js';
...
,''
            ...
            function setRefinerLabel(termId, defaultValue, Id)
            {
               if(termId != null && termId != "")
                {
                    ...
                    clientContext.executeQueryAsync(
                        function() {
                            if(termDefaultValue != null && document.getElementById(Id) != null)
                            {
                                document.getElementById(Id).innerHTML = termDefaultValue.m_value != "" ? termDefaultValue.m_value : defaultValue;
                                
                            }
                        },
                        function(sender, args){ console.log('getRefinerLabel Request failed for Term -' + termId + ' Error: ' + args.get_message() + '\n' + args.get_stackTrace()); }
                        );
                }
...
,'        <div id="EmptyContainer"></div>'
                ...
                else
                {
                    ...
                    console.log(refinerCatTitle, isExpanded);
        ms_outHtml.push(''
,'        <div id="Container">'
);
                ...
                function outputFilter(refinementName, refinementCount, refiners, method, aClass, showCounts) {
                    ...
                    if(!(method == "updateRefinersJSON")){
                        obj = Sys.Serialization.JavaScriptSerializer.serialize(refiners);
                        termIdIndex = obj.indexOf("#0");

                        if(termIdIndex > 0)
                        {
                           guid = obj.substr(obj.indexOf("#0") + 2,36);
                        }
                    }
                    var guidID = 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function(c) {var r = Math.random()*16|0,v=c=='x'?r:r&0x3|0x8;return v.toString(16);});
...
,'                <a id="FilterLink" class="', $htmlEncode(aClass) ,'" onclick="', aOnClick ,'" href="javascript:{}" title="', $htmlEncode(String.format(Srch.U.loadResource("rf_RefineBy"), refinementName)) ,'">'
                        ...
                        if (termIdIndex > 0) {
                    ms_outHtml.push(''
,'                    <span id="', guidID ,'" class="', nameClass ,'" style="float:left;font-family: Arial, Helvetica, sans-serif; width: 95%"> ', $htmlEncode(setRefinerLabel(guid, refinementName, guidID)) ,' </span>'
);
                    } else {
                    ms_outHtml.push(''
,''
,'                    <span id="', guidID ,'" class="', nameClass ,'" style="float:left;font-family: Arial, Helvetica, sans-serif;width: 95%"> ', $htmlEncode(refinementName) ,' </span>'
);
                    }
                    ms_outHtml.push(''
);
                        if (showCounts) {
                    ms_outHtml.push(''
,'                    <span id="', guidID ,'" class="ms-ref-count float-right" style="display:block;float:right;width:5%"> ', $htmlEncode(Srch.U.toFormattedNumber(refinementCount)) ,' </span>'
);
                        }
                    ms_outHtml.push(''
,'                </a>'
...
function RegisterTemplate_16fe896fe68c4ee78da7535ff7577ab2() {

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("Filter_Item_BLG_Refinement_Accordion", DisplayTemplate_16fe896fe68c4ee78da7535ff7577ab2);
}

if ("undefined" != typeof (Srch) &&"undefined" != typeof (Srch.U) &&typeof(Srch.U.registerRenderTemplateByName) == "function") {
  Srch.U.registerRenderTemplateByName("~sitecollection\u002f_catalogs\u002fmasterpage\u002fBLGPublishing\u002fDisplay Templates\u002fSearch\u002fFilter_BLGDefault.js", DisplayTemplate_16fe896fe68c4ee78da7535ff7577ab2);
}

}
RegisterTemplate_16fe896fe68c4ee78da7535ff7577ab2();
if (typeof(RegisterModuleInit) == "function" && typeof(Srch.U.replaceUrlTokens) == "function") {
  RegisterModuleInit(Srch.U.replaceUrlTokens("~sitecollection\u002f_catalogs\u002fmasterpage\u002fBLGPublishing\u002fDisplay Templates\u002fSearch\u002fFilter_BLGDefault.js"), RegisterTemplate_16fe896fe68c4ee78da7535ff7577ab2);
}